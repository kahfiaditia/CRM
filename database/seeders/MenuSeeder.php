    ...
    public function run()
    {
        ...
        $table_menu = [
            ...
            [
                ...
                'typemenu' => 'view',
                'icon_menu' => 'bx bx-notepad font-size-24 text-warning',
                'status' => '1',
                'order_menu' => '2',
                'created_at' => Carbon::now(),
            ],
            ...
            [
                ...
                // 'route_menu' => '',
                // 'typemenu' => '',
                'icon_menu' => 'bx bx-archive-in font-size-24 text-warning',
                'status' => '1',
                'order_menu' => '5',
                'created_at' => Carbon::now(),
            ],
            [
                ...
                // 'route_menu' => '',
                // 'typemenu' => '',
                'icon_menu' => 'bx bx-shape-circle font-size-24 text-warning',
                'status' => '1',
                'order_menu' => '6',
                'created_at' => Carbon::now(),
            ],
